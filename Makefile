...
PROGNAME = StarwarsShooter

# The object files you want to compile into your program
# This should be a space (SPACE!) separated list of .o files
OFILES = main.o mylib.o sprites/millfalc.o sprites/tiefighter.o sprites/deathstar.o sprites/titlescreen.o sprites/gameover.o sprites/explosion.o sprites/tiefighter1.o sprites/gameover1.o text.o starwars.o font.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = sprites/millfalc.h header.h sprites/tiefighter.h sprites/deathstar.h sprites/titlescreen.h sprites/gameover.h sprites/explosion.h sprites/tiefighter1.h sprites/gameover1.h text.h starwars.h
